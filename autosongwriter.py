...
df = pd.read_csv("/Users/abhijeet/Python/python/autosongwriter/data/musicoset_songfeatures/lyrics.csv", sep="\t")
df.head()
...
pdf = pd.read_csv('/Users/abhijeet/Python/python/autosongwriter/data/PoetryFoundationData.csv',quotechar='"')
pdf.head()
